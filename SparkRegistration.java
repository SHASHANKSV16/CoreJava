class SparkRegistration {
    ...
    public static boolean registerUser(String pen, String empName, String dob, long aadhaar,
        ...
        // if (isValidPEN && isValidName && isValidDOB && isValidAadhaar &&
            ...
            // isRegistered = true;
        // }
	boolean isVaild = SparkRegistrationValidator.validator(pen, empName, dob, aadhaar,phone, pass, confirmPass);
		if(isVaild) 
			isRegistered = true;
		else
    ...
    public static void getDetails() {
	 ...
	 permanentEmployeeNumber = SparkRegistrationValidator.permanentEmployeeNumber;
     name = SparkRegistrationValidator.name;
     dateOfBirth = SparkRegistrationValidator.dateOfBirth;
    aadhaarNumber = SparkRegistrationValidator.aadhaarNumber;
    mobileNumber = SparkRegistrationValidator.mobileNumber;
     password = SparkRegistrationValidator.password;
     confirmPassword= SparkRegistrationValidator.confirmPassword;
