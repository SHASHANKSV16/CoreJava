...
public class ShopingMallRunner {
    public static void main(String[] args) {
        ...
        Shop shop1=new Shop(1,"M K Stores","Provision",3,"nandini Layout");
        ...
        if(shopingMall.addShop(shop1)&&shopingMall.addShop(shop2)&&shopingMall.addShop(shop3)&&
                shopingMall.addShop(shop4)&&shopingMall.addShop(shop5)&&shopingMall.addShop(shop6)&&
                shopingMall.addShop(shop7)&&shopingMall.addShop(shop8)&&shopingMall.addShop(shop9)&&
                shopingMall.addShop(shop10)&&shopingMall.addShop(shop11)&&shopingMall.addShop(shop12)&&
