...
public class CompanyRunner {
    public static void main(String[] args) {
        ...
        if(company.addProject(project1)&&company.addProject(project2)&&company.addProject(project3)&&
                company.addProject(project4)&&company.addProject(project5)&&company.addProject(project6)&&
                company.addProject(project7)&&company.addProject(project8)&&company.addProject(project9)&&
                company.addProject(project10)&&company.addProject(project11)&&company.addProject(project12)&&
                company.addProject(project13)&&company.addProject(project14)&&company.addProject(project15)&&
                company.addProject(project16)&&company.addProject(project17)&&company.addProject(project18)&&
                company.addProject(project19)&&company.addProject(project20)){
