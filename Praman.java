class Praman {
    ...
    public static boolean registerUser(long phone, String name, String gen, String dob,
        ...
        // if (isValidMobile && isValidName && isValidGender && isValidDOB &&
            ...
            // isRegistered = true;
        // }
	boolean isValid = PramanValidator.validator(phone,  name,  gen, dob, userName, pass, confirmPass);
	if(isValid) 
		isRegistered =  true;
	else
	...
	mobileNumber = PramanValidator.mobileNumber;
     givenName= PramanValidator.givenName;
     gender= PramanValidator.gender;
     dateOfBirth= PramanValidator.dateOfBirth;
     username= PramanValidator.username;
     password = PramanValidator.password;
     confirmPassword = PramanValidator.confirmPassword;
