class PAN {
    ...
    public static boolean registrationUser(String lName,String fName,String pwd,String cpwd) {
        ...
        // }
		boolean isValidated = PANValidator.validateUser(lName,fName,pwd,cpwd);
		if(isValidated)   isRegistrationUser = true;
		else System.out.println("user not validated");
    ...
    public static void getDetails() {
		surname = PANValidator.surname;
		firstName= PANValidator.firstName;
		password = PANValidator.password;
		confirmPassword = PANValidator.confirmPassword;
