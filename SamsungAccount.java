class SamsungAccount {
    ...
    public static boolean registrationUser(String eMail, String pass, String confirmPass, String fName, String lName) {
        ...
        // if (isValidEmail && isValidPassword && isValidConfirm && isValidFirstName && isValidLastName) {
            ...
            // isRegistered = true;
        // }
	boolean isVaild = SamsungAccountValidator.validator(eMail, pass, confirmPass, fName, lName);
		if(isVaild) 
			isRegistered = true;
		else
	...
	email = SamsungAccountValidator.email;
    password = SamsungAccountValidator.password;
    confirmPassword = SamsungAccountValidator.confirmPassword;
    firstName = SamsungAccountValidator.firstName;
    lastName = SamsungAccountValidator.lastName;
